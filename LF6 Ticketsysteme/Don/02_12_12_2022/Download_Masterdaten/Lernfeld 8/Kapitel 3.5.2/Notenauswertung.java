...
public class Notenauswertung {
	...
	public static void notenAuswerten() {
		...
		System.out.println("In der Klassenarbeit wurden " +
							anzahlProNote[0] + " Einsen geschrieben");
		System.out.println("In der Klassenarbeit wurden " +
		                    anzahlProNote[1] + " Zweien geschrieben");
		System.out.println("In der Klassenarbeit wurden " +
		                    anzahlProNote[2] + " Dreien geschrieben");	
		System.out.println("In der Klassenarbeit wurden " +
				            anzahlProNote[3] + " Vieren geschrieben");
		System.out.println("In der Klassenarbeit wurden " +
				            anzahlProNote[4] + " Fünfen geschrieben");
		System.out.println("In der Klassenarbeit wurden " +
				            anzahlProNote[5] + " Sechsen geschrieben");
		System.out.println("Der Notendurchschnitt ist: " +
				            durchschnitt);
	}
}
